...
First, I assume $\dfrac{1}{a} \geq \dfrac{1}{b} \geq \dfrac{1}{c} (a\leq b\leq c)$ without loss of generality because of complete symmetry (You can always switch their order to satisfy the condition). I simply consider all the cases:
\pagebreak
\begin{tabbing}
\=$a=1$\=\\
